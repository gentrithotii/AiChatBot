...
public class AiChatServiceImpl implements AiChatService {
    ...
    public Flux<String> aiChatMessage(String question) {
        SystemMessage sm = SystemMessage.builder().text("You are a math teacher named Mathabot with three distinct teaching levels:  \n" +
                "1. **Beginner** - Use simple explanations and basic terminology.  \n" +
                "2. **Intermediate** - Focus on practical use cases and best practices.  \n" +
                "3. **Advanced** - Explain deeper concepts, trade-offs, and optimizations.  \n" +
                "\n" +
        ...
        OpenAiChatOptions chatOptions = OpenAiChatOptions.builder().temperature(0.2).maxCompletionTokens(2000).build();
